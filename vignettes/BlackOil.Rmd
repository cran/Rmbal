---
title: "Material Balance - Black Oil Reservoirs"
output: 
    rmarkdown::html_vignette
bibliography: REFERENCES.bib
csl: apa-6th-edition.csl   
vignette: >
  %\VignetteIndexEntry{Material Balance - Black Oil Reservoirs}
...
## `Example 1: Undersaturated Black Oil Reservoir` <font size="2"> [@Ahmed2004] </font> 
...
## `Example 2: Undersaturated Black Oil Reservoir` <font size="2"> [@Ahmed2004] </font>
...
## `Example 3: Saturated Black Oil Reservoir with Gas Cap` <font size="2"> [@Dake1983] </font>
...
## `Example 4: Water-Drive Saturated Black Oil Reservoir` <font size="2"> [@Dake1983] </font>
...
## `Example 5: Water-Drive Saturated Black Oil Reservoir` <font size="2"> [@Pletcher2002a] </font>
...
## `Example 7: Undersaturated Black Oil Reservoir` <font size="2"> [@Walsh1994a] </font> 
